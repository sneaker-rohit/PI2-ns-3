/*
 * This script simulates a mix of TCP and UDP traffic for PIE evaluation
...
int main (int argc, char *argv[])
{
  ...
  std::string pcapFileName = "pie-third.pcap";
  ...
  if (writeForPlot)
    {
      filePlotQueueDel << pathOut << "/" << "pie-third-delay.plotme";
  ...
  flowmon.SerializeToXmlFile ("pie-third.xml", true, true);
