...
int main (int argc, char *argv[])
{
  ...
  std::string pcapFileName = "pi-square-third-lowdelay.pcap";
  ...
  Config::SetDefault ("ns3::PiSquareQueueDisc::QueueDelayReference", TimeValue (Seconds (0.005)));
  ...
  if (writeForPlot)
    {
      filePlotQueueDel << pathOut << "/" << "pi-square-third-lowdelay.plotme";
  ...
  flowmon.SerializeToXmlFile ("pi-square-third-lowdelay.xml", true, true);
